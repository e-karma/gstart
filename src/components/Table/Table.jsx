...
import style from "./tableStyle.jsx";
              ...
              >
                {prop.map((prop, key) => {
                  const tableCellClasses =
                    ...
                    " " +
                    cx({
                      [classes[variablesColls[coloredColls.indexOf(key)]]]:
...
CustomTable.propTypes = {
  ...
  // Of(["warning","primary","danger","success","info","rose","gray"]) - variablesColls
  variablesColls: PropTypes.array,
